...
const API_KEY = "9e90cee8562444298e062907251002";
...
const displayHourlyForecast = (hourlyData) => {
    ...
    // filtering to only get the next 24 hours data
    ...
    // generating html for each hourly forecast 
...
const getWeatherDetails = async(API_URL) => {
    ...
    try{
        // fetch weather data form API and parse into JSON
        ...
        // combine hourly data of today and tomorrow
...
locationButton.addEventListener("click" , () => {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        alert("Location access denied. please enable Location permission to use this feature");
    })
});
